...
--Q.1 Write an SQL Query to retrive all columns for sales made on '2022-11-05'.
--Q.2 Write an SQL Query to retrive all transactions where the category is 'clothing' and the quantity sold is more than 4 in the month of Nov-2022.
--Q.3 Write an SQL Query to calculate the total sales (total_sales) for each category.
...
--Q.7 Write an SQL Query to calculate the average sale for each month. Find out best selling moth in each year.
